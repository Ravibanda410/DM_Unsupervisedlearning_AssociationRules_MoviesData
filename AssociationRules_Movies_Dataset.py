# -*- coding: utf-8 -*-
"""
Created on Wed Sep 23 17:53:37 2020
...
#movies = []
#with open("C:/RAVI\Data science/Assignments/DM-UnsupervisedLearning-AssociationRules/Datasets/my_movies.csv",sep=",")as f:movies = f.read()
movies = pd.read_csv("C:/RAVI\Data science/Assignments/DM-UnsupervisedLearning-AssociationRules/Datasets/my_movies.csv",sep=",")
...
data_dummies = pd.read_csv("C:/RAVI\Data science/Assignments/DM-UnsupervisedLearning-AssociationRules/Datasets/my_movies.csv")
